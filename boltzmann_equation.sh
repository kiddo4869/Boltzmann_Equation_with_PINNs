...
# Debugging
#python boltzmann_equation.py --name debug --debug --phase train --optimizer l-bfgs --hamiltonian input \
...
# L-BFGS Optimizer
python boltzmann_equation.py --name l-bfgs_new_III --phase test --optimizer l-bfgs --log_loss --hamiltonian input --case_idx 3 \
                             --N_initial 2500 --N_boundary 100 --N_collocation 100000 \
                             --N_initial_val 650 --N_boundary_val 650 --N_collocation_val 650 \
                             --IC_weight 0.5 --BC_weight 0.0 --PDE_weight 0.5 --learning_rate 0.01 --epochs 5000 \
