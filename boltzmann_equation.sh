...
python boltzmann_equation.py --name debug --debug --phase train --optimizer l-bfgs --hamiltonian \
                             --N_initial 100 --N_boundary 500 --N_collocation 100 \
                             --N_initial_val 100 --N_boundary_val 500 --N_collocation_val 100 \
                             --IC_weight 0.0 --BC_weight 1.0 --PDE_weight 0.0 --learning_rate 1.0 --epochs 1000
# Adam Optimizer
